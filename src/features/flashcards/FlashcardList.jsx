      ...
      {!loading && !error && visible.length > 0 && (
        <div className="grid grid-cols-2 gap-4 max-md:grid-cols-1">
          {visible.map(d => (
            <div
              key={d.id}
              className="bg-surface rounded-card shadow-card p-5 cursor-pointer border-l-4 border-primary hover:shadow-hover hover:-translate-y-px transition-all flex flex-col"
